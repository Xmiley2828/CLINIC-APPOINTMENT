            ...
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-doctor">
                        <a href="doctors.php" class="non-style-link-menu"><div><p class="menu-text">All Consultants</p></a></div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <tr>
                        <td >
                            ...
                            <p>Haven't any idea about consultants? no problem let's jumping to 
                                <a href="doctors.php" class="non-style-link"><b>"All Consultants"</b></a> section or 
                                <a href="schedule.php" class="non-style-link"><b>"Sessions"</b> </a><br>
                                Track your past and future appointments history.<br>Also find out the expected arrival time of your consultant or medical consultant.<br><br>
                            </p>
                            
                            <h3>Channel a Consultant Here</h3>
